...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200"> {{ $date->day }} число, {{ $date->translatedFormat('F') }}, {{ $date->year }} , {{$date->format('H:i')}} --- Комменты- {{ $post->comments->count() }}</p>
                        ...
                        <form action="{{ route('post.comment.store', $post->id) }}" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-12" data-aos="fade-up">
                                    ...
                                    <textarea name="message" id="comment" class="form-control" placeholder="Писать здесь" rows="10"></textarea>
                                </div>
                            </div>
                            <div class="row">
                            </div>
